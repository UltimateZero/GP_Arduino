...
#define echoPin 4 // Echo Pin for ultrasonic
#define trigPin 5 // Trigger Pin for ultrasonic
#define buttonPin 2
#define CAN_FULL_CAPACITY  40 // in CM
#define SSID "UltimateAP"
#define PASS "zero1994"
...
//  Serial.println(btnState != isBtnPressed);
...
int calculatePercentage() {
  ...
  return 100 - (cm * 100.0 / CAN_FULL_CAPACITY);
}
